...
#define AI_NETWORK_ORIGIN_MODEL_NAME   "apnea_cnn_small"
...
#define AI_NETWORK_IN_1_HEIGHT      (6000)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (6000)
#define AI_NETWORK_IN_1_SIZE_BYTES  (24000)
