...
#define AI_NETWORK_MODEL_SIGNATURE     "0xc1bfc7d0352d62db02bc1fc58c191e89"
...
#define AI_TOOLS_DATE_TIME   "2025-12-11T15:07:41-0800"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, 0x0,
  AI_SHAPE_INIT(4, 1, 16, 1, 375), AI_STRIDE_INIT(4, 4, 4, 64, 64),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  6, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 1, 188), AI_STRIDE_INIT(4, 4, 4, 128, 128),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  11, 0x0,
  AI_SHAPE_INIT(4, 1, 8, 1, 1500), AI_STRIDE_INIT(4, 4, 4, 32, 32),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  12, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 1, 7), AI_STRIDE_INIT(4, 4, 4, 4, 4),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  14, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 7, 8), AI_STRIDE_INIT(4, 4, 4, 32, 32),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  24, 0x0,
  AI_SHAPE_INIT(4, 1, 1, 1, 6000), AI_STRIDE_INIT(4, 4, 4, 4, 4),
...
AI_LAYER_OBJ_DECLARE(
  ...
  .pool_size = AI_SHAPE_2D_INIT(1, 188), 
  .pool_stride = AI_SHAPE_2D_INIT(1, 188), 
...
AI_LAYER_OBJ_DECLARE(
  ...
  .filter_stride = AI_SHAPE_2D_INIT(1, 2), 
  .dilation = AI_SHAPE_2D_INIT(1, 1), 
  .filter_pad = AI_SHAPE_INIT(4, 1, 0, 3, 0), 
...
AI_LAYER_OBJ_DECLARE(
  ...
  .filter_stride = AI_SHAPE_2D_INIT(1, 2), 
  .dilation = AI_SHAPE_2D_INIT(1, 1), 
  .filter_pad = AI_SHAPE_INIT(4, 2, 0, 4, 0), 
  .pool_size = AI_SHAPE_2D_INIT(1, 2), 
  .pool_stride = AI_SHAPE_2D_INIT(1, 2), 
  .pool_pad = AI_SHAPE_INIT(4, 0, 0, 0, 0), 
  .pool_func = AI_HANDLE_PTR(pool_func_mp_array_f32), 
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 13508, 1, 1),
    13508, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 48448, 1, 1),
    48448, NULL, NULL),
  ...
  &conv1d_conv2d_layer, 0x5898fd3d, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    input_layer_output_array.data = AI_PTR(g_network_activations_map[0] + 24284);
    input_layer_output_array.data_start = AI_PTR(g_network_activations_map[0] + 24284);
    conv1d_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 48284);
    conv1d_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 48284);
    conv1d_conv2d_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 48312);
    conv1d_conv2d_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 48312);
    conv1d_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 160);
    conv1d_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 160);
    conv1d_1_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 48160);
    conv1d_1_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 48160);
    conv1d_1_conv2d_scratch1_array.data = AI_PTR(g_network_activations_map[0] + 48320);
    conv1d_1_conv2d_scratch1_array.data_start = AI_PTR(g_network_activations_map[0] + 48320);
    ...
    conv1d_2_conv2d_scratch0_array.data = AI_PTR(g_network_activations_map[0] + 24000);
    conv1d_2_conv2d_scratch0_array.data_start = AI_PTR(g_network_activations_map[0] + 24000);
    conv1d_2_conv2d_output_array.data = AI_PTR(g_network_activations_map[0] + 24192);
    conv1d_2_conv2d_output_array.data_start = AI_PTR(g_network_activations_map[0] + 24192);
    ...
    global_average_pooling1d_pool_output_array.data = AI_PTR(g_network_activations_map[0] + 24064);
    global_average_pooling1d_pool_output_array.data_start = AI_PTR(g_network_activations_map[0] + 24064);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    conv1d_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 224);
    conv1d_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 224);
    conv1d_1_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_1_conv2d_weights_array.data = AI_PTR(g_network_weights_map[0] + 256);
    conv1d_1_conv2d_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 256);
    conv1d_1_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_1_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 2816);
    conv1d_1_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 2816);
    conv1d_2_conv2d_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_2_conv2d_weights_array.data = AI_PTR(g_network_weights_map[0] + 2880);
    conv1d_2_conv2d_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 2880);
    conv1d_2_conv2d_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_2_conv2d_bias_array.data = AI_PTR(g_network_weights_map[0] + 9024);
    conv1d_2_conv2d_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 9024);
    dense_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 9152);
    dense_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 9152);
    dense_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 13248);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 13248);
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 13376);
    dense_1_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 13376);
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 13504);
    dense_1_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 13504);
    return true;
  }
